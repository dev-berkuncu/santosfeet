...
<head>
    ...
    <meta name="description" content="<?= e($metaDesc ?? 'GTA V fictional character photo gallery – fan-made, non-official.') ?>">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <form class="d-flex me-2" action="<?= SITE_URL ?>/search.php" method="GET">
                <input class="form-control form-control-sm me-2" type="search" name="q" placeholder="Search character…" value="<?= e($_GET['q'] ?? '') ?>">
